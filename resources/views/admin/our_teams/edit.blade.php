<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        ...
        <form action="{{ route('our_team.update', $our_team->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('name.en', $our_team->name['en'] ?? '') }}" type="text"
                    ...
                    <div>
                        ...
                        <input value="{{ old('position.en', $our_team->position['en'] ?? '') }}" type="text"
                            name="position[en]" id="position_en"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-sm">
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('name.kh', $our_team->name['kh'] ?? '') }}" type="text"
                    ...
                    <div>
                        ...
                        <input value="{{ old('position.kh', $our_team->position['kh'] ?? '') }}" type="text"
                            name="position[kh]" id="position_kh"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-sm">
            ...
            <!-- Dropzone for Image -->
            <div>
                <label for="dropzone-file{{ $our_team->id }}" id="drop-area"
                    ...
                    <div class="flex flex-col items-center justify-center pt-5 pb-6 w-full h-full bg-contain bg-center bg-no-repeat rounded-md text-center"
                        id="img-preview" style="background-image: url({{ asset($our_team->image) }})">
                        ...
                        <p class="text-xs text-[#000]">SVG, PNG, JPG (Size 800 x 800 px)</p>
                    </div>
                    <input id="dropzone-file{{ $our_team->id }}" type="file" class="hidden" name="image"
