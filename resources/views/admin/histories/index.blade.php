...
@section('content')
    <div class="">
        <div class="my-4 px-2 md:px-4 flex items-center justify-between">
                            ...
                            <tr class="border-t border-[#966927]">
                                ...
                                <td class="py-3 px-4 text-xs max-w-[200px] border-r border-[#966927]">
                                    <div class="flex flex-col truncate">
                                        <p>{{ $history->title['en'] ?? '' }}</p>
                                        <p>{{ $history->title['kh'] ?? '' }}</p>
                                    </div>
                                </td>
                                <td class="py-3 px-4 text-xs max-w-[200px] border-r border-[#966927]">
                                ...
                                <td class="py-3 px-4 text-xs max-w-[200px]">
                                    <div class="flex items-center">
                                        <a href="{{ route('history.delete', $history->id) }}" title="Delete"
                                            onclick="event.preventDefault(); deleteRecord('{{ route('history.delete', $history->id) }}')">
                                        ...
                                        <a href="{{ route('history.edit', $history->id) }}" title="Edit">
